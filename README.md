...
| `TERMINAL_IDLE_TIMEOUT_MS`            | `0` (disabled)               | Reap an **attached** terminal after this many ms with no input and no output. `0` = never |
| `DECKTERM_ORPHAN_TTL_HOURS`           | `0` (disabled)               | Reap a **detached** terminal after this many hours with no input and no output. `0` = never |
| `DECKTERM_TAB_CLOSE_GRACE_MS`         | `900000`                     | Restore window after closing a tab with the X, before the session ends                                                                                                                                                                                   |
