 ...
 * Original file: /npm/xterm-addon-search@0.13.0/lib/xterm-addon-search.js
 *
        ...
        class n extends r.Disposable {
          constructor(e) {
            ...
            (super(),
              ...
              (this._onDidChangeResults = this.register(new t.EventEmitter())),
              (this.onDidChangeResults = this._onDidChangeResults.event),
              (this._highlightLimit =
                null !== (i = null == e ? void 0 : e.highlightLimit) &&
                void 0 !== i
                  ? i
                  : 1e3));
          }
          activate(e) {
            ((this._terminal = e),
              ...
              this.register(
                (0, r.toDisposable)(() => this.clearDecorations()),
              ));
          }
          _updateMatches() {
            var e;
            (this._highlightTimeout &&
              ...
              this._cachedSearchTerm &&
                (null === (e = this._lastSearchOptions) || void 0 === e
                  ? void 0
                  : e.decorations) &&
                (this._highlightTimeout = setTimeout(() => {
                  ...
                  ((this._cachedSearchTerm = void 0),
                    this.findPrevious(
                      e,
                      Object.assign(
                        Object.assign({}, this._lastSearchOptions),
                        { incremental: !0, noScroll: !0 },
                      ),
                    ));
                }, 200)));
          }
          clearDecorations(e) {
            (this._selectedDecoration.clear(),
              (0, r.disposeArray)(this._highlightDecorations),
              (this._highlightDecorations = []),
              this._highlightedLines.clear(),
              e || (this._cachedSearchTerm = void 0));
          }
          findNext(e, t) {
            if (!this._terminal)
              throw new Error("Cannot use addon until it has been loaded");
            ((this._lastSearchOptions = t),
              (null == t ? void 0 : t.decorations) &&
                ((void 0 !== this._cachedSearchTerm &&
                  e === this._cachedSearchTerm) ||
                  this._highlightAllMatches(e, t)));
          ...
          _highlightAllMatches(e, t) {
            ...
            const i = [];
            let s,
              r = this._find(e, 0, 0, t);
            for (
              ;
              r &&
              ((null == s ? void 0 : s.row) !== r.row ||
                (null == s ? void 0 : s.col) !== r.col) &&
              !(i.length >= this._highlightLimit);
            )
              ((s = r),
                i.push(s),
                (r = this._find(
                  e,
                  s.col + s.term.length >= this._terminal.cols
                    ? s.row + 1
                    : s.row,
                  s.col + s.term.length >= this._terminal.cols ? 0 : s.col + 1,
                  t,
                )));
            for (const e of i) {
              const i = this._createResultDecoration(e, t.decorations);
              i &&
                (this._highlightedLines.add(i.marker.line),
          ...
          _find(e, t, i, s) {
            var r;
            if (!this._terminal || !e || 0 === e.length)
              return (
                null === (r = this._terminal) ||
                  void 0 === r ||
                  r.clearSelection(),
                void this.clearDecorations()
              );
            if (i > this._terminal.cols)
              throw new Error(
                `Invalid col: ${i} to search in terminal of ${this._terminal.cols} cols`,
              );
            let o;
            this._initLinesCache();
            const n = { startRow: t, startCol: i };
            if (((o = this._findInLine(e, n, s)), !o))
              for (
                let i = t + 1;
                i < this._terminal.buffer.active.baseY + this._terminal.rows &&
                ((n.startRow = i),
                (n.startCol = 0),
                (o = this._findInLine(e, n, s)),
                !o);
                i++
              );
            return o;
          ...
          _findNextAndSelect(e, t) {
            ...
            return (
              !l &&
                s &&
                ((n.startRow = s.start.y),
                (n.startCol = 0),
                (l = this._findInLine(e, n, t))),
              this._selectResult(
                l,
                null == t ? void 0 : t.decorations,
                null == t ? void 0 : t.noScroll,
              )
            );
          }
          findPrevious(e, t) {
          ...
          _findPreviousAndSelect(e, t) {
            ...
            if (
              (s &&
                ((l.startRow = r = s.start.y),
                (l.startCol = o = s.start.x),
                this._cachedSearchTerm !== e &&
                  ((h = this._findInLine(e, l, t, !1)),
                  h ||
                    ((l.startRow = r = s.end.y), (l.startCol = o = s.end.x)))),
              h || (h = this._findInLine(e, l, t, n)),
              !h)
            ) {
              ...
              for (
                let i = r - 1;
                i >= 0 &&
                ((l.startRow = i), (h = this._findInLine(e, l, t, n)), !h);
                i--
              );
            }
            if (
              !h &&
              r !== this._terminal.buffer.active.baseY + this._terminal.rows - 1
            )
              for (
                let i =
                  this._terminal.buffer.active.baseY + this._terminal.rows - 1;
          ...
          _initLinesCache() {
            ...
            (this._linesCache ||
              ((this._linesCache = new Array(e.buffer.active.length)),
              (this._cursorMoveListener = e.onCursorMove(() =>
          ...
          _isWholeWord(e, t, i) {
            return (
              (0 === e || o.includes(t[e - 1])) &&
              (e + i.length === t.length || o.includes(t[e + i.length]))
            );
          }
          _findInLine(e, t, i = {}, s = !1) {
            var r;
            const o = this._terminal,
              n = t.startRow,
              l = t.startCol,
              h = o.buffer.active.getLine(n);
            if (null == h ? void 0 : h.isWrapped)
              return s
                ? void (t.startCol += o.cols)
                : (t.startRow--,
                  (t.startCol += o.cols),
                  this._findInLine(e, t, i));
            let a =
              null === (r = this._linesCache) || void 0 === r ? void 0 : r[n];
            a ||
              ((a = this._translateBufferLineToStringWithWrap(n, !0)),
              this._linesCache && (this._linesCache[n] = a));
            const [c, d] = a,
              _ = this._bufferColsToStringOffset(n, l),
              u = i.caseSensitive ? e : e.toLowerCase(),
            ...
            if (i.regex) {
              ...
              let i;
              if (s)
                for (; (i = t.exec(f.slice(0, _))); )
                  ((g = t.lastIndex - i[0].length),
                    (e = i[0]),
                    (t.lastIndex -= e.length - 1));
              else
                ((i = t.exec(f.slice(_))),
                  i &&
                    i[0].length > 0 &&
                    ((g = _ + (t.lastIndex - i[0].length)), (e = i[0])));
            } else
              s
                ? _ - u.length >= 0 && (g = f.lastIndexOf(u, _ - u.length))
                : (g = f.indexOf(u, _));
            if (g >= 0) {
              ...
              const r = g - d[t],
                l = g + e.length - d[s],
                h = this._stringLengthToBufferSize(n + t, r);
              return {
                term: e,
                col: h,
                row: n + t,
                size:
                  this._stringLengthToBufferSize(n + s, l) -
                  h +
                  o.cols * (s - t),
              };
            }
          ...
          _bufferColsToStringOffset(e, t) {
            ...
            let s = e,
              r = 0,
              o = i.buffer.active.getLine(s);
            for (; t > 0 && o; ) {
              for (let e = 0; e < t && e < i.cols; e++) {
                const t = o.getCell(e);
                if (!t) break;
                t.getWidth() &&
                  (r += 0 === t.getCode() ? 1 : t.getChars().length);
              }
              if ((s++, (o = i.buffer.active.getLine(s)), o && !o.isWrapped))
                break;
              t -= i.cols;
            }
            return r;
          ...
          _translateBufferLineToStringWithWrap(e, t) {
            ...
            for (; n; ) {
              const l = s.buffer.active.getLine(e + 1),
                h = !!l && l.isWrapped;
          ...
          _selectResult(e, t, i) {
            const s = this._terminal;
            if ((this._selectedDecoration.clear(), !e))
              return (s.clearSelection(), !1);
            if ((s.select(e.col, e.row, e.size), t)) {
              const i = s.registerMarker(
                -s.buffer.active.baseY - s.buffer.active.cursorY + e.row,
              );
              if (i) {
                ...
                if (o) {
                  ...
                  (s.push(i),
                    s.push(
                      o.onRender((e) =>
                        this._applyStyles(e, t.activeMatchBorder, !0),
                      ),
                    ),
                    s.push(o.onDispose(() => (0, r.disposeArray)(s))),
            ...
            if (
              !i &&
              (e.row >= s.buffer.active.viewportY + s.rows ||
                e.row < s.buffer.active.viewportY)
            ) {
          ...
          _applyStyles(e, t, i) {
            (e.classList.contains("xterm-find-result-decoration") ||
              ...
              i && e.classList.add("xterm-find-active-result-decoration"));
          }
          _createResultDecoration(e, t) {
            const i = this._terminal,
              s = i.registerMarker(
                -i.buffer.active.baseY - i.buffer.active.cursorY + e.row,
              );
            if (!s) return;
            const o = i.registerDecoration({
              ...
              overviewRulerOptions: this._highlightedLines.has(s.line)
                ? void 0
                : { color: t.matchOverviewRuler, position: "center" },
            });
            if (o) {
              const e = [];
              (e.push(s),
                e.push(
                  o.onRender((e) => this._applyStyles(e, t.matchBorder, !1)),
                ),
                e.push(o.onDispose(() => (0, r.disposeArray)(e))));
            }
            return o;
          }
        }
